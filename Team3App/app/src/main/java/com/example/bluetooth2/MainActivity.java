...
public class MainActivity extends Activity {
  ...
  private static String address =  "20:14:12:17:05:76"; //"30:14:12:17:24:02";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    checkBTState();
      ...
      for (final Button button_i: map.keySet()) {
          button_i.setOnTouchListener(new View.OnTouchListener() {
              private Handler mHandler;
              private String buttonCmd = map.get(button_i);
              public boolean onTouch(View v, MotionEvent event) {
                  ...
                  switch (event.getAction()) {
                      case MotionEvent.ACTION_DOWN:
                          ...
                          mHandler.postDelayed(mAction, 10); // 1/100 second response delay
                          break;
              ...
              Runnable mAction = new Runnable() {
                  @Override public void run() {
                      mConnectedThread.write(buttonCmd);
                      mHandler.postDelayed(this, 100); // while held send 1/10 second
                  }
              };
